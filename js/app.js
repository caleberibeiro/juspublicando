    ...
    return `
        <div style="padding: 1rem 1.5rem; border-top: 1px solid rgba(255,255,255,0.05);">
            <div class="flex gap-2 mb-2">
                <button class="btn btn-sm btn-primary" onclick="event.stopPropagation(); openAddPrazoModalFor('${processo.id}')">
                    + Adicionar Prazo
                </button>
            </div>
            ${prazosHtml}
...
function renderConfig() {
    ...
    main.innerHTML = `
        ...
        <div class="config-section mt-4">
            ...
            <p class="text-muted" style="font-size: 0.85rem; margin-bottom: 1rem;">
                Exporte ou importe seus dados (processos, prazos, configurações).
            </p>
            <div class="flex gap-2">
